    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_STOP_PROGRESS_DIALOG:
                ...
                ((Button) findViewById(R.id.searchButton)).setClickable(false);
                ((LinearLayout) findViewById(R.id.secondLine)).setVisibility(View.VISIBLE);
                break;
            default:
                break;
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* Call the remote object's Ping method. */
                Message msg = mBusHandler.obtainMessage(BusHandler.PING, mEditText.getText().toString());
                mBusHandler.sendMessage(msg);
            }
        });
    }
